...
<body>
    <div id="app">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('transaction.form')}}">{{ __('Transaction') }}</a>
                            </li>
                            <li class="nav-item">
                            <a class="nav-link" href="{{ route('transfer') }}">{{ __('Transfer') }}</a>
                            </li>
                             <li class="nav-item">
                            <a class="nav-link" href="{{ route('deposit.form') }}">{{ __('Deposit check') }}</a>
                            </li>
        ...
        {{-- <footer style="margin-top:-25px;" class="navbar navbar-expand-md navbar-light navbar-laravel">
                <p class="mr-auto">© Copyright 2018 LN Bank</p>
